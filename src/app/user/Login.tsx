  ...
  const onFinish = async ({
    ...
    try {
      ...
      const result = unwrapResult(
        await dispatch(login({ email, password, isStaySignedIn }))
      );
  ...
  return (
    <Container>
      ...
      <Navigator
        ...
        link={
          <Link to="/user/signup" tabIndex={-1}>
            Sign Up
          </Link>
        }
      />
      ...
      >
        ...
        <Form.Item name="isStaySignedIn" valuePropName="checked">
          <Checkbox tabIndex={-1}>Stay signed in</Checkbox>
        </Form.Item>
        <Form.Item>
          <Button
            htmlType="submit"
